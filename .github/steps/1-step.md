...
1. In the **Code** tab of your repository, create a new branch named `welcome-workflow`.
   ...
   <img width="400" alt="create branch screenshot" src="https://github.com/nancykesarwani02-ui/Basic_GH_Actions_Workflow/blob/main/.github/images/create-branch-screenshot.png?raw=true" />
